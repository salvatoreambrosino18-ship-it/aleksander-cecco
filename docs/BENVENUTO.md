...
## Le cinque cose che farai più spesso

**1. Cambiare un prezzo o le taglie**
Apri il capo. Il prezzo e le taglie sono in cima al modulo, sotto le
fotografie. Cambia e premi Publish.

**2. Aggiungere o riordinare le fotografie**
Stanno in cima al capo. La prima della lista apre la pagina, ed è anche quella
...
## Quanto ci mette una modifica ad apparire

Questa è la regola che si dimentica sempre, ed è l'unica che devi ricordare.

**1.** Cambi quello che vuoi e premi **Publish**, in basso a destra. Finché non
lo premi, la modifica esiste solo per te.

**2.** Il sito si rifà da solo. Ci mette **qualche minuto**, non è immediato.

Se non vedi il cambiamento subito **non rifarlo**. Aspetta cinque minuti e
ricarica la pagina tenendo premuto Shift. Nove volte su dieci era solo il
telefono che teneva la versione vecchia.
...
## Due cose da non toccare

**L'indirizzo della pagina di un capo già online.** I link che hai già mandato
in giro smetterebbero di funzionare.

In alto a destra nel pannello c'è un menu che dice **Drafts** e qualche icona
accanto. Sono cose di Sanity, non del tuo sito. Non ti servono e non rompono
niente.
...
La guida completa è `GUIDA-STUDIO.md` e risponde a quasi tutto, ma per
cominciare non ti serve.

Se una cosa non si vede, guarda prima la regola dei cinque minuti qui sopra.
Se dopo cinque minuti non si vede ancora, scrivici.
